...
public:
     ...
     */
    std::string encode(const std::string& rawText, const std::string& key, const std::string& iv = std::string());
     ...
     */
    std::string decode(const std::string& rawText, const std::string& key, const std::string& iv = std::string());
     ...
     */
    std::string expandKey(const std::string& key, bool isEncryptionKey);
...
private:
    ...
    void addRoundKey(const uint8_t round, const std::string & expKey);
    void subBytes();
    void shiftRows();
    void mixColumns();
    void invMixColumns();
    void invSubBytes();
    void invShiftRows();
    std::string getPadding(int currSize, int alignment);
    std::string cipher(const std::string & expKey, const std::string & in);
    std::string invCipher(const std::string & expKey, const std::string & in);
    std::string byteXor(const std::string & a, const std::string & b);
